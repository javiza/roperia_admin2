...
export class DbService {
  ...
  platform: string = "";
  iniciado: boolean = false;  // Cambiar a false por defecto
  ...
  async iniciarPlugin() {
    try {
      ...
      console.log("DbService::iniciarPlugin plataforma=" + this.platform);
      ...
      this.iniciado = true; // Establecer a true solo después de una inicialización exitosa
    } catch (e) {
  ...
  async cerrarConexion() {
    if (this.db) {
      ...
      console.error("No hay conexión abierta para cerrar.");
    }
  }
  ...
  async insertar(prenda: Prenda) {
    ...
    console.log("Prenda insertada:", prenda);
  }
  ...
  async actualizar(prenda: Prenda) {
    ...
    console.log("Prenda actualizada:", prenda);
  }
  ...
  async eliminar(id: number) {
    ...
    console.log(`Prenda con ID ${id} eliminada.`);
  }
}
